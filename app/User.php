...
class User extends Authenticatable
{
    ...
    public function homePagePosts() {
        return $this->posts()->where('is_trashed', 0)->where('is_archived', 0)->limit(20)->get()->unique();
    }
    /**
     * Relationships
     */
    ...
    public function posts() {
        return Media::select('medias.id as post_id', 'medias.description as description', 'medias.url as file_url', 'medias.type as file_type', 'medias.created_at', 'medias.updated_at', 'users.name as poster_name', 'users.id as poster_id', 'users.username as poster_username', 'users.email as poster_email')
